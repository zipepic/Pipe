...
//    }
    ...
    public void testEquals_AnyClassWithoutParametrization() {
        HandlerArgument arg1 = new HandlerArgument(TypeNode.buildTree(List.of(Object.class)));
        HandlerArgument arg2 = new HandlerArgument(TypeNode.buildTree(List.of(String.class)));
        assertTrue(arg1.equals(arg2));
    }
    @Test
    public void testEquals_AnyClassWithoutParametrization2() {
        HandlerArgument arg1 = new HandlerArgument(TypeNode.buildTree(List.of(List.class, Object.class)));
        HandlerArgument arg2 = new HandlerArgument(TypeNode.buildTree(List.of(String.class)));
        assertFalse(arg1.equals(arg2));
    }
}
